 ...
 */
public class ShiftLocalServiceClp implements ShiftLocalService {
	public ShiftLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public java.util.List<com.lftechnology.ticketbookingsystem.admin.model.Shift> getShifts(
		...
		return (java.util.List<com.lftechnology.ticketbookingsystem.admin.model.Shift>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.lftechnology.ticketbookingsystem.admin.model.Shift updateShift(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(shift), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
