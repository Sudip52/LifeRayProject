...
/**
 * The persistence utility for the hall service. This utility wraps {@link HallPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class HallUtil {
	 ...
	 */
	public static void clearCache(Hall hall) {
		getPersistence().clearCache(hall);
	}
	 ...
	 */
	public static List<Hall> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static Hall update(Hall hall, boolean merge)
		throws SystemException {
		return getPersistence().update(hall, merge);
	}
	...
	public static Hall update(Hall hall, boolean merge,
		...
		return getPersistence().update(hall, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(hall);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(halls);
	}
	...
	* @return the new hall
	*/
	public static com.lftechnology.ticketbookingsystem.admin.model.Hall create(
		long id) {
	...
	*/
	public static com.lftechnology.ticketbookingsystem.admin.model.Hall remove(
		long id)
	...
	public static com.lftechnology.ticketbookingsystem.admin.model.Hall updateImpl(
		com.lftechnology.ticketbookingsystem.admin.model.Hall hall,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(hall, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.ticketbookingsystem.admin.model.Hall findByPrimaryKey(
		long id)
		throws com.lftechnology.ticketbookingsystem.admin.NoSuchHallException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lftechnology.ticketbookingsystem.admin.model.Hall fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lftechnology.ticketbookingsystem.admin.model.Hall> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static HallPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (HallPersistence)PortletBeanLocatorUtil.locate(com.lftechnology.ticketbookingsystem.admin.service.ClpSerializer.getServletContextName(),
					HallPersistence.class.getName());

			ReferenceRegistry.registerReference(HallUtil.class, "_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(HallPersistence persistence) {
	}

	private static HallPersistence _persistence;
}