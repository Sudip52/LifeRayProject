...
public class MovieLocalServiceClp implements MovieLocalService {
	public MovieLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.lftechnology.ticketbookingsystem.admin.model.Movie addMovie(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(movie) });
		}
		catch (Throwable t) {
	...
	public com.lftechnology.ticketbookingsystem.admin.model.Movie updateMovie(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(movie), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
