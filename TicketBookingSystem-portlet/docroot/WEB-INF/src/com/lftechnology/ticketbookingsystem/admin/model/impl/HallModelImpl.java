...
/**
 * The base model implementation for the Hall service. Represents a row in the &quot;AD_Hall&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class HallModelImpl extends BaseModelImpl<Hall> implements HallModel {
	 ...
	 */
	public static final String TABLE_NAME = "AD_Hall";
	...
	public static final String TABLE_SQL_CREATE = "create table AD_Hall (id_ LONG not null primary key,hallname VARCHAR(75) null,contact_no VARCHAR(75) null,companyId LONG,groupId LONG)";
	public static final String TABLE_SQL_DROP = "drop table AD_Hall";
