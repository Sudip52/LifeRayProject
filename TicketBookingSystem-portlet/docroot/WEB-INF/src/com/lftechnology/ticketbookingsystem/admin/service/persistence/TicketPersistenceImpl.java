...
import com.lftechnology.ticketbookingsystem.admin.model.impl.TicketModelImpl;
...
public class TicketPersistenceImpl extends BasePersistenceImpl<Ticket>
	 ...
	 */
	public Ticket remove(long id) throws NoSuchTicketException, SystemException {
	...
	protected Ticket toUnwrappedModel(Ticket ticket) {
		...
		ticketImpl.setId(ticket.getId());
		ticketImpl.setTicketname(ticket.getTicketname());
		ticketImpl.setPrice(ticket.getPrice());
		ticketImpl.setCompanyId(ticket.getCompanyId());
		ticketImpl.setGroupId(ticket.getGroupId());
	...
	public Ticket findByPrimaryKey(long id)
		throws NoSuchTicketException, SystemException {
		Ticket ticket = fetchByPrimaryKey(id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Ticket fetchByPrimaryKey(long id) throws SystemException {
		...
		if (ticket == null) {
			...
			try {
				...
				ticket = (Ticket)session.get(TicketImpl.class, Long.valueOf(id));
			}
			catch (Exception e) {
				hasException = true;
				...
				if (ticket != null) {
					...
					EntityCacheUtil.putResult(TicketModelImpl.ENTITY_CACHE_ENABLED,
						TicketImpl.class, id, _nullTicket);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.lftechnology.ticketbookingsystem.admin.model.Ticket")));
